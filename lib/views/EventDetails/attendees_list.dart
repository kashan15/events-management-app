...
class AttendeesList extends StatefulWidget {
  ...
  AttendeesList({this.attendeesLength, Key? key}) : super(key: key);
...
class _AttendeesListState extends State<AttendeesList> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      onModelReady: (model){
          // GetAttendee().getAllEventsDetails(attendeeModel, )
      },
                  ...
                  child: Container(
                    ...
                    ListView.separated(
                      ...
                      shrinkWrap: true,
                        ...
                        itemCount: model.attendeeLength!,
                    ) :
                        Center(
                          child: Text("No Attendee Found",
                            style: TextStyle(
                              fontFamily: FontUtils.avertaSemiBold,
                              fontSize: 2.5.t,
                              color: ColorUtils.darkText,
