...
class EventDetails extends StatefulWidget {
  ...
  EventDetails({this.index, this.eventId, this.fname, Key? key}) : super(key: key);
  // EventDetails({required this.index, Key? key}) : super(key: key);
        ...
        return model.isLoading == false
            ...
            SafeArea(
                ...
                child: Scaffold(
                  ...
                  model.upComingeventsList[widget.index!].UserId !=
                          model.userId
                      ?
                  Container(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: MaterialButton(
                                ...
                                shape: RoundedRectangleBorder(
                                  ...
                                  // for(var i =0; i <model.attendeesDetails.length;i++){
                                  //   // model.myAttendingEventsList[i].isCheck = false;
                                  // }

                                  // for(var i =0; i <model.attendeeLength;i++){
                                  //   // model.checkBoxListTileModel[i].isCheck = false;
                                  // }

                                  // for(var i =0; i <model.checkBoxListOneTileModel.length;i++){
                                  //   model.checkBoxListOneTileModel[i].isCheck = false;
                                  // }
                                ...
                                onPressed: () {
                                  ...
                                  // model.attenddEvent(context);

                                  AttendEvent().attendingTheEvents(
                                    model.userId??'',
                                      // model.upComingeventsList[widget.index].UserId??'',
                                      model.fName??'',
                                     // model.upComingeventsList[widget.index].fname??'',
                              ...
                              children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(model.upComingeventsList[widget.index!].eventDate!.split(' ')[0].substring(8, 10) +
                                                  " " +
                                                  DateFormat('MMMM').format(DateTime(0, int.parse(model.upComingeventsList[widget.index!].eventDate!.split(' ')[0].substring(5, 7)))).toString() +
                                                  "," +
                                                  " " +
                                                  model.upComingeventsList[widget.index!].eventDate!.split(' ')[0].substring(0, 4),
                                              style: TextStyle(
                                                  fontFamily:
                                                      FontUtils.avertaSemiBold,
                                                  fontSize: 2.t,
                                            ...
                                            Text(
                                              DateFormat('EEEE').format(DateTime.parse(model.upComingeventsList[widget.index!].eventDate!.split(' ')[0])) +
                                                  "," +
                                                  " " +
                                                  // DateFormat.jm().format(DateTime.parse(model.upComingeventsList[widget.index].eventDate! + " " + model.upComingeventsList[widget.index].timeFrom!)) +
                                                  // " - " +
                                                  // DateFormat.jm().format(DateTime.parse(model.upComingeventsList[widget.index].eventDate! + " " + model.upComingeventsList[widget.index].timeTo!)),

                                              model.upComingeventsList[widget.index!].timeFrom!
                                                  +
                                                  " - " +
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    if(model.upComingeventsList[widget.index!].UserId !=
                                        model.userId)
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.push(
