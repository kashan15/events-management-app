...
const double _kTrackWidth = 40.0;
...
class CustomSwitch extends StatelessWidget {
  ...
  /// Creates an adaptive [CustomSwitch] based on whether the target platform is iOS
  ...
  /// The color of this [CustomSwitch]'s thumb.
  ///
  ...
  /// The color of this [CustomSwitch]'s track.
  ///
  /// Resolved in the following states:
  ///  * [MaterialState.selected].
  ///  * [MaterialState.hovered].
