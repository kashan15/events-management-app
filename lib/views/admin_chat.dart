    ...
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return GestureDetector(
          onTap: (){
            context.unFocus();
            model.adminEmojiSelected = false;
            model.adminEmojiShowing = false;
            setState(() {
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ExpandTapWidget(
                                            onTap: () {
                                              model.adminEmojiShowing = !model.adminEmojiShowing;
                                              model.adminEmojiSelected = !model.adminEmojiSelected;
                                              SchedulerBinding.instance!.addPostFrameCallback((_) {
                                                model.adminScrollController.jumpTo(model.adminScrollController.position.maxScrollExtent);
                                              });
                                              setState(() {
                                              });
                                            },
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextField(
                                                ...
                                                controller: model.adminChatController,
                            ...
                            SizedBox(height: 2.h,),
                            if(model.adminEmojiSelected == true)
                              Container(
                                height: 30.h,
                                child: Offstage(
                                  offstage: !model.adminEmojiShowing,
                                  child: EmojiPicker(
                                      onEmojiSelected: (Category category, Emoji emoji) {
                                        model.adminOnEmojiSelected(emoji);
                                      },
                                      onBackspacePressed: model.adminOnBackspacePressed,
                                      config: Config(
                                          columns: 7,
